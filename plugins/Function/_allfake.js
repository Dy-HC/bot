...
handler.all = async function( m ) {
  ...
  try {
    ...
    global.kontak2 = [
      [ owner[ 0 ], await mufar.getName( owner[ 0 ] + '628970404980@s.whatsapp.net' ), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'f10909143@gmail.com', true ],
      [ owner[ 1 ], await mufar.getName( owner[ 1 ] + '@s.whatsapp.net' ), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'f10909143@gmail.com', true ],
    ]
